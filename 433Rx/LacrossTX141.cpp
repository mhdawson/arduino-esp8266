...
LacrossTX141::LacrossTX141(PubSubClient* client, char* topic) :
...
INTERRUPT_SAFE void LacrossTX141::processPulse(long duration) {
  // any pulse less than MIN_PULSE_LENGTH means we have noise so
  // we are not in the middle of a transmision
