...
#ifndef _ARDUINO_LIGHT_SENSOR_DEVICE
#define _ARDUINO_LIGHT_SENSOR_DEVICE
...
class ArduinoLightSensor : public Device, public MqttDevice {
  public:
    ArduinoLightSensor(PubSubClient* client, char* topic);
